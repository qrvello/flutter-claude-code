...
description: Expert in generating production-ready Flutter UI code from design specifications. Specializes in pixel-perfect implementation, responsive layouts, animations, and accessibility. Use proactively for code generation from designs.
model: opus
color: cyan
---
