...
description: Expert in profiling and analyzing Flutter app performance. Specializes in DevTools profiling, identifying jank, memory leaks, and performance bottlenecks. Use proactively for performance analysis and profiling.
model: opus
color: orange
---
