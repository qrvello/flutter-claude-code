...
description: Expert in Flutter application architecture, Clean Architecture, project structure, dependency injection, and navigation design. Use proactively for architecture decisions and project setup.
model: opus
color: blue
---
