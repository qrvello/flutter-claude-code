...
description: Expert in managing iOS simulators and Android emulators for Flutter development. Specializes in device launch, app installation, screenshot capture, and multi-device testing. Use proactively for device management tasks.
model: opus
color: purple
---
