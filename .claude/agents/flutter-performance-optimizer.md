...
description: Expert in implementing Flutter performance optimizations. Specializes in widget optimization, const constructors, keys, RepaintBoundary, and efficient rendering patterns. Use proactively for applying performance fixes.
model: opus
color: orange
---
