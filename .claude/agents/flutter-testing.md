...
description: Expert in Flutter testing including unit tests, widget tests, integration tests, BLoC testing, mocking, and test-driven development. Use proactively for writing tests and improving test coverage.
model: opus
color: green
---
